...
var editTask = function(taskId){
    ...
    // get contenet from task name an type
...
var deleteTask = function(taskId){
    ...
    for(var i = 0; i < tasks.length; i++){
        //if tasks[i].id doesnt match the value of taskId, lets leep that task and push it into the new array
...
var completeEditTask = function(taskName, taskType, taskId){
    ...
    //loop through tasks array and task object with new contnet
    for(var i = 0; i <tasks.length; i++){
        if(tasks[i].id === parseInt(taskId)){
...
var loadTasks = function(){
    ...
    for(var i = 0; i < tasks.length; i++){
        ...
        else if(tasks[i].status === "compelete"){
